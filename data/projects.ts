...
export const projects: Project[] = [
  ...
  // ── Category B: GHL ───────────────────────────────────────────
  {
    ...
    // "comm" is commercial, not community — the original title mis-expanded the
    // subdomain. The slug stays `strong-refuge-pool-community` so the existing
    // URL keeps resolving; only the display title is corrected.
    title: 'Strong Refuge Pool — Commercial',
    url: 'https://comm.strongrefugepool.com/',
    category: 'ghl',
    role: 'Commercial Pool Services Funnel',
    description:
      'Built a B2B commercial pool services quote funnel in GoHighLevel. Facility type and services needed are captured up front, so maintenance programs are scoped to the property rather than quoted blind.',
    tags: ['GoHighLevel', 'B2B Lead Gen', 'Quote Routing', 'Facility Scoping', 'Maintenance'],
  ...
  },
  {
    ...
    category: 'ghl',
    role: 'Pool Cover Estimate Funnel Builder',
    description:
      'Built a residential pool cover estimate funnel in GoHighLevel. Address autocomplete, cover-type selection and bot-protected submissions feed the CRM, with financing prompts built into the flow.',
    tags: ['GoHighLevel', 'Lead Gen', 'Address Autocomplete', 'Bot Protection', 'CRO'],
    image: '/images/projects/strong-refuge-pool-funnel.jpg',
    gradientFrom: '#0a1a0a',
    gradientVia: '#0f2d0f',
    gradientTo: '#0a150a',
    accentHex: '#34d399',
  },
  {
    ...
    category: 'ghl',
    role: 'Compliance Assessment Funnel Designer',
    description:
      'Built a commercial pool compliance funnel in GoHighLevel. Frames the cost of failed inspections — fines, shutdowns, insurance loss — then routes facility assessments by property type.',
    tags: ['GoHighLevel', 'Compliance', 'B2B Lead Gen', 'Facility Routing', 'Mobile-First'],
    image: '/images/projects/strong-refuge-pool-compliance.jpg',
    gradientFrom: '#12100a',
    gradientVia: '#1e1a0f',
    gradientTo: '#100e0a',
    accentHex: '#fbbf24',
  },
  {
    ...
    category: 'ghl',
    role: 'Equipment Repair Funnel Developer',
    description:
      'Built a pool equipment repair funnel in GoHighLevel. Symptom-led diagnosis prompts, equipment-type routing across pumps, heaters, filters and salt systems, and a free-diagnostic booking path.',
    tags: ['GoHighLevel', 'Service Lead Gen', 'Equipment Routing', 'Diagnostics'],
    image: '/images/projects/strong-refuge-pool-equipment.jpg',
    gradientFrom: '#0a1214',
    gradientVia: '#0f1e22',
    gradientTo: '#0a1012',
    accentHex: '#22d3ee',
  },
  {
    ...
    description:
      'Built the booking funnel for a $299 discovery flight lesson in Sarasota. Sells a logged, credit-bearing lesson rather than a joyride, with the training path laid out step by step before signup.',
    tags: ['GoHighLevel', 'Aviation', 'Offer Funnel', 'CRM Automation', 'Lead Gen'],
    image: '/images/projects/wingman-aero-uft.jpg',
    gradientFrom: '#0a0f1e',
    gradientVia: '#0f1a30',
    gradientTo: '#0a0c18',
    accentHex: '#818cf8',
  },
  {
    ...
    category: 'ghl',
    role: 'Peptide Therapy Consultation Funnel',
    description:
      'Built a physician-supervised peptide therapy consultation funnel in GoHighLevel. Leads with practitioner credentials and compliance signals — HIPAA, A4M, 503A pharmacies — ahead of the booking form.',
    tags: ['GoHighLevel', 'Health & Wellness', 'Consultation Booking', 'Compliance', 'Trust Signals'],
    image: '/images/projects/beyond-remedy-ny-injectables.jpg',
    gradientFrom: '#1a0a12',
    gradientVia: '#2d0f1e',
    gradientTo: '#140a0f',
    accentHex: '#f472b6',
  },
  {
    ...
    category: 'ghl',
    role: 'Longevity Program Funnel Engineer',
    description:
      'Built the consultation funnel for a physician-led longevity program. Positions concierge diagnostics — blood panels, hormone work, DEXA, MRI — against med-spa comparison, gated by partner referral.',
    tags: ['GoHighLevel', 'Longevity', 'Concierge Health', 'Referral Gating', 'Consultation'],
    image: '/images/projects/beyond-remedy-co-main.jpg',
    gradientFrom: '#0a1410',
    gradientVia: '#0f2018',
    gradientTo: '#0a120e',
    accentHex: '#2dd4bf',
  },
  {
    ...
    category: 'ghl',
    role: 'EdTech Consultation Funnel Builder',
    description:
      'Built the free-session booking funnel for an academic coaching service. Mirrors the parent\'s own words back at them — procrastination, lost homework, nightly arguments — before asking for the booking.',
    tags: ['GoHighLevel', 'EdTech', 'Consultation Booking', 'Objection Handling', 'Social Proof'],
    image: '/images/projects/swoon-learning-start.jpg',
    gradientFrom: '#0a0f1a',
    gradientVia: '#141e30',
    gradientTo: '#0a0f16',
    accentHex: '#a78bfa',
  },
  {
    ...
    description:
      'Built a multi-step auto-accident intake funnel for Metro Atlanta. Qualifies on accident recency and injury type, routes across legal, medical, police-report and property-damage tracks, with SMS consent handled.',
    tags: ['GoHighLevel', 'Legal', 'Multi-Step Intake', 'Qualification Logic', 'SMS Consent'],
    image: '/images/projects/my-injury-case-help.jpg',
    gradientFrom: '#12080a',
    gradientVia: '#200f12',
    gradientTo: '#100808',
    accentHex: '#fb7185',
